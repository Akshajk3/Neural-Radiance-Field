...
for img_index in range(80, 100):
    ...
    plt.axis('off')
    plt.savefig(f'generated_images/generated_image_{img_index}.png', bbox_inches='tight')
    plt.close()

    print(f'Finished generating index {img_index}')